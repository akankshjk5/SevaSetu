...
const NAV = [
  ...
  { href: "/household/post", key: "hh.nav.book", icon: "➕" },
  { href: "/household/team", key: "hh.nav.team", icon: "👥" },
  { href: "/household/bookings", key: "hh.nav.bookings", icon: "🧾" },
];
    ...
    <div className="min-h-dvh pb-20">
      <header className="sticky top-0 z-20 border-b border-slate-200 bg-white">
        <div className="mx-auto flex max-w-3xl items-center justify-between gap-3 px-4 py-3">
          <Link href="/household" className="flex min-h-11 items-center gap-2 font-extrabold text-brand">
